                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 content-offset">
                                    <div id="content">
                                        <div style="padding: 12px 18px; margin-bottom: 20px; margin-top: 20px;">
                                            <h1 style="text-align: center; margin-bottom: 6px; color: #678361;">Üzgünüm!</h1>
                                            <span style="display: block; text-align: center; margin-bottom: 10px;"><img src="<?php echo base_url('assets/img/error.png'); ?>" alt="checkmark"/></span>
                                            <p style="text-align: center; font-weight: 700;">Ödeme işleminde hata oluştu.</p>
